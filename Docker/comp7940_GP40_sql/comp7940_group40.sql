...
(1, '九龍','獅子山','在慈雲山北巴士總站後方的梯級開步，沿水泥路走經修建妥善的石級抵達沙田坳。在馬路轉角處見麥理浩徑的告示牌，循徑上行，攀升一段後路徑漸見平緩，及後遇上分支直走（左路可下走至沙田坳村）。在一山坳處，隨指示牌登上獅子山再往前走，輕攀大石可到達獅位置，頭眺望九龍半島。從獅子頭側的明顯小徑接回麥理浩徑，不久便到達回歸紀念亭。由此續走至畢架山發射站的馬路，沿徑續走至涼亭。及後離開麥理浩徑左走，在支路再左轉下走至龍翔道，最後橫越公路便可下走抵蘇屋村。', '小巴 37A', '巴士 2/112 號', 4),
...
(4, '離島', '蒲台島', '在蒲台碼頭下船後左走，先略過「第三段」指示牌，直往天后廟。而天后廟旁就是「響螺石」。返回「第三段」指示牌，靠左方設有綠色欄杆的小徑上山。繞過電力站路段漸開揚，沿空白的指示牌往上走，時而傾斜，時而茂密，最後接回蒲台島郊遊徑。沿徑直走至涼亭小休（右沿郊遊徑經棺材石往碼頭）。及後再緩步而下，見支路經「靈龜上山」、「僧人石」等名勝直往燈塔（右沿郊遊徑可往碼頭。續沿徑而走便見「佛手巖」，接回剛才支路，踏海岸小徑，往觀「摩崖石刻」返回碼頭。', '街渡(星期二、四、六、日及公眾假期)', '街渡(星期二、四、六、日及公眾假期)', 2.5),
(5, '大嶼山', '大東山', '在南山的牌樓上走至直昇機坪，輕降後便開始登山。沿徑一路攀升，便可到達雙東坳。再往前走，經過黃龍坑郊遊徑的地圖指示牌，便會到達大東山的爛頭營。從石屋間的小徑繼續前進，輕攀山坳，再走過一段較平坦的路段，便要往下走。最後隨著石級下降至伯公坳完成旅程。', '巴士 1/2/3M/4 號', '巴士 11/23 號', 3.5)
